        ...
        for i in range(30, len(df)):
            ...
            if position is None:
                ...
                if position == "long":
                    ...
                    if all(x is not None and not math.isnan(x) for x in [close_price, max_price, entry_price]):
                    ...
                    if all(x is not None and not math.isnan(x) for x in [close_price, min_price, entry_price]):
